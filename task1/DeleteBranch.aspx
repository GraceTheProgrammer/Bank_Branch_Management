<%@ Page Title="" Language="C#" MasterPageFile="~/BranchDashboard.Master" AutoEventWireup="true" CodeBehind="DeleteBranch.aspx.cs" Inherits="task1.DeleteBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- header has two buttons add, and view and edit  --%>
    <div class="header">
        <h1>Branch Administration</h1>
        <asp:Button runat="server" CssClass="h_btn" Text="Add Branch" ID="add_btn" PostBackUrl="~/AddBranch.aspx" />
        <asp:Button ID="view_btn" CssClass="h_btn" runat="server" Text="View and Edit Branch" PostBackUrl="~/viewBranches.aspx" />
    </div>
